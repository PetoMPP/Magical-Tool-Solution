...
namespace MTSLibrary.Connections
{
    ...
    {
        public void CreateClGrParameter(ToolClassParameterModel model) => throw new NotImplementedException();
        ...
        public void CreateMainClass(MainClassModel model) => throw new NotImplementedException();
        ...
        public CompModel GetBasicCompModelById(string text) => throw new NotImplementedException();

        public ToolModel GetBasicToolModelById(string text) => throw new NotImplementedException();

        public List<ToolClassModel> GetToolClassesList() => throw new NotImplementedException();

        public List<MainClassModel> GetClassesListByMainClassId(string id) => throw new NotImplementedException();

        public string GetClassNameById(string parentClassId) => throw new NotImplementedException();
        ...
        public void UpdateMainClass(MainClassModel model) => throw new NotImplementedException();
        ...
        public string ValidateClassGroupId(string toolClass, string toolGroup) => throw new NotImplementedException();
        ...
        public string ValidateMachineInterfaceId(string machineInterface) => throw new NotImplementedException();
        ...
        public string ValidateParameters(List<ParameterModel> parameters) => throw new NotImplementedException();
